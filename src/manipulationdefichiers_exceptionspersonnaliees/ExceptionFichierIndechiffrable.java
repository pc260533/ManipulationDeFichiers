 ...
 */
public class ExceptionFichierIndechiffrable extends ExceptionPersonnalisee {
     ...
     */     
    public ExceptionFichierIndechiffrable(Throwable precedenteException) {
        super("Le fichier ne peut pas être déchiffrer par l'algorithme de déchiffrement.", "Fichier indéchiffrable.", precedenteException);
    }
